...
var FittedImage = (function () {
    ...
    FittedImage.decorators = [
        { type: Component, args: [{
                    ...
                    template: "<div class=\"fitted-image\"> <img [src]=\"photo.url\" [ngStyle]=\"imageStyle\" (load)=\"imageLoad($event)\" [hidden]=\"loading\" alt=\"\" onerror=\"this.src='./assets/fallback.png'\" /> </div> ",
